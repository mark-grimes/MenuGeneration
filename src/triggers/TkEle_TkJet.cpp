...
namespace l1menu
{
	namespace triggers
	{
		 ...
		 * @date 03/Jun/2013
		 */
		class TkEle_TkJet_v0 : public l1menu::triggers::CrossTrigger
		{
		public:
			TkEle_TkJet_v0();
		 ...
		 */
		REGISTER_TRIGGER_AND_CUSTOMISE( TkEle_TkJet_v0,
			[]() // Use a lambda function to customise rather than creating a named function that never gets used again.
			{
				l1menu::TriggerTable& triggerTable=l1menu::TriggerTable::instance();
				TkEle_TkJet_v0 tempTriggerInstance;
...
l1menu::triggers::TkEle_TkJet_v0::TkEle_TkJet_v0()
	: CrossTrigger( new l1menu::triggers::SingleTkEleEta_v0, new l1menu::triggers::SingleTkJet_v0 )
{
	// No operation besides passing the sub-triggers onto the base class
}

const std::string l1menu::triggers::TkEle_TkJet_v0::name() const
{
