...
namespace l1menu
{
	namespace triggers
	{
		 ...
		 * @date 04/Jun/2013
		 */
		class DoubleTkJet_v0 : public l1menu::triggers::MultiTkJet_v0
		{
		public:
			DoubleTkJet_v0();
		 ...
		 */
		REGISTER_TRIGGER_AND_CUSTOMISE( DoubleTkJet_v0,
...
l1menu::triggers::DoubleTkJet_v0::DoubleTkJet_v0()
{
	numberOfJets_=2;
}

const std::string l1menu::triggers::DoubleTkJet_v0::name() const
{
	return "L1_DoubleTkJet";
}

unsigned int l1menu::triggers::DoubleTkJet_v0::version() const
{
	return 0;
}

const std::vector<std::string> l1menu::triggers::DoubleTkJet_v0::parameterNames() const
{
...
float& l1menu::triggers::DoubleTkJet_v0::parameter( const std::string& parameterName )
{
...
const float& l1menu::triggers::DoubleTkJet_v0::parameter( const std::string& parameterName ) const
{
	if( parameterName!="numberOfJets" ) return MultiTkJet::parameter(parameterName);
	else throw std::logic_error( "Not a valid parameter name" );
}
