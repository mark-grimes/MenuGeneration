...
bool l1menu::triggers::SingleIsoEGEta_v0::apply( const l1menu::L1TriggerDPGEvent& event ) const
{
...
bool l1menu::triggers::SingleIsoEGEta_v0::thresholdsAreCorrelated() const
{
	return false;
}
