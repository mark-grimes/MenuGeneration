...
namespace l1menu
{
	namespace triggers
	{
		 ...
		 * @date 03/Jun/2013
		 */
		class EG_Mu_v0 : public l1menu::triggers::CrossTrigger
		{
		public:
			EG_Mu_v0();
		 ...
		 */
		REGISTER_TRIGGER_AND_CUSTOMISE( EG_Mu_v0,
			[]() // Use a lambda function to customise rather than creating a named function that never gets used again.
			{
				l1menu::TriggerTable& triggerTable=l1menu::TriggerTable::instance();
				EG_Mu_v0 tempTriggerInstance;
...
l1menu::triggers::EG_Mu_v0::EG_Mu_v0()
	: CrossTrigger( new l1menu::triggers::SingleEGEta_v0, new l1menu::triggers::SingleMuEta_v0 )
{
	// No operation besides passing the sub-triggers onto the base class
}

const std::string l1menu::triggers::EG_Mu_v0::name() const
{
	return "L1_EG_Mu";
}

unsigned int l1menu::triggers::EG_Mu_v0::version() const
{
	return 0;
}
