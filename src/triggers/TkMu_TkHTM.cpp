...
namespace l1menu
{
	namespace triggers
	{
		 ...
		 * @date 03/Jun/2013
		 */
		class TkMu_TkHTM_v0 : public l1menu::triggers::CrossTrigger
		{
		public:
			TkMu_TkHTM_v0();
		 ...
		 */
		REGISTER_TRIGGER_AND_CUSTOMISE( TkMu_TkHTM_v0,
			[]() // Use a lambda function to customise rather than creating a named function that never gets used again.
			{
				l1menu::TriggerTable& triggerTable=l1menu::TriggerTable::instance();
				TkMu_TkHTM_v0 tempTriggerInstance;
				triggerTable.registerSuggestedBinning( tempTriggerInstance.name(), "leg1threshold1", 100, 0, 100 );
				triggerTable.registerSuggestedBinning( tempTriggerInstance.name(), "leg2threshold1", 150, 0, 300 );
...
l1menu::triggers::TkMu_TkHTM_v0::TkMu_TkHTM_v0()
	: CrossTrigger( new l1menu::triggers::SingleTkMuEta_v0, new l1menu::triggers::TkHTM_v0 )
{
	// No operation besides passing the sub-triggers onto the base class
}

const std::string l1menu::triggers::TkMu_TkHTM_v0::name() const
{
	return "L1_TkMu_TkHTM";
}

unsigned int l1menu::triggers::TkMu_TkHTM_v0::version() const
{
	return 0;
}
