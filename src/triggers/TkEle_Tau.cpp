...
namespace l1menu
{
	namespace triggers
	{
		 ...
		 * @date 03/Jun/2013
		 */
		class TkEle_Tau_v0 : public l1menu::triggers::CrossTrigger
		{
		public:
			TkEle_Tau_v0();
...
l1menu::triggers::TkEle_Tau_v0::TkEle_Tau_v0()
	: CrossTrigger( new l1menu::triggers::SingleTkEleEta_v0, new l1menu::triggers::SingleTauJet_v0 )
{
	// No operation besides passing the sub-triggers onto the base class
}

const std::string l1menu::triggers::TkEle_Tau_v0::name() const
{
	return "L1_TkEle_Tau";
}
