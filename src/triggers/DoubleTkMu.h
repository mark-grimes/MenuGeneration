#ifndef l1menu_triggers_DoubleTkMu_h
#define l1menu_triggers_DoubleTkMu_h
...
namespace l1menu
{
	namespace triggers
	{
		...
		/** @brief Base class for all versions of the DoubleTkMu trigger.
		 *
		 ...
		 * @date 02/Jun/2013
		 */
		class DoubleTkMu : public l1menu::ITrigger
		{
		public:
			DoubleTkMu();
		 ...
		 * @date sometime
		 */
		class DoubleTkMu_v0 : public DoubleTkMu
		{
		public:
