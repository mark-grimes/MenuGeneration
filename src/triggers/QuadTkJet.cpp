...
namespace l1menu
{
	namespace triggers
	{
		 ...
		 * @date 04/Jun/2013
		 */
		class QuadTkJet_v0 : public l1menu::triggers::MultiTkJet_v0
		{
		public:
			QuadTkJet_v0();
		 ...
		 */
		REGISTER_TRIGGER_AND_CUSTOMISE( QuadTkJet_v0,
			[]() // Use a lambda function to customise rather than creating a named function that never gets used again.
			{
				l1menu::TriggerTable& triggerTable=l1menu::TriggerTable::instance();
				QuadTkJet_v0 tempTriggerInstance;
...
l1menu::triggers::QuadTkJet_v0::QuadTkJet_v0()
{
	numberOfJets_=4;
}

const std::string l1menu::triggers::QuadTkJet_v0::name() const
{
	return "L1_QuadTkJet";
}

unsigned int l1menu::triggers::QuadTkJet_v0::version() const
{
	return 0;
}

const std::vector<std::string> l1menu::triggers::QuadTkJet_v0::parameterNames() const
{
...
float& l1menu::triggers::QuadTkJet_v0::parameter( const std::string& parameterName )
{
...
const float& l1menu::triggers::QuadTkJet_v0::parameter( const std::string& parameterName ) const
{
	if( parameterName!="numberOfJets" ) return MultiTkJet::parameter(parameterName);
	else throw std::logic_error( "Not a valid parameter name" );
}
