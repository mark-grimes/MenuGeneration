...
namespace l1menu
{
	namespace triggers
	{
		 ...
		 * @date 03/Jun/2013
		 */
		class TkTau_Tau_v0 : public l1menu::triggers::CrossTrigger
		{
		public:
			TkTau_Tau_v0();
...
l1menu::triggers::TkTau_Tau_v0::TkTau_Tau_v0()
	: CrossTrigger( new l1menu::triggers::SingleTkTauEta_v0, new l1menu::triggers::SingleTauJet_v0 )
{
	// No operation besides passing the sub-triggers onto the base class
}

const std::string l1menu::triggers::TkTau_Tau_v0::name() const
{
	return "L1_TkTau_Tau";
}
